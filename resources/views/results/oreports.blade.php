...
@section('body')
    <div class="container-fluid">
        <h5 class="mb-0 text-uppercase fw-bold text-center mb-3" style="color: purple;">O-level Reports</h5>
        ...
        $(document).ready(function() {
            ...
            $("#print_reports").on('click', function(e) {
                ...
                $.ajax({
                    ...
                    url: "/Results/report_olevel_print/"+tables+"/"+term+"/"+year+"/"+student_ids+"",
                    success: function(data) {
                        window.open("/Results/report_olevel_print/"+tables+"/"+term+"/"+year+"/"+student_ids+"", '_blank');
                        //Enable the button
